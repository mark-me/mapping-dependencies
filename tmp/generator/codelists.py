...
class CodeList:
    ...
    def write_CodeLists(self):
        ...
        Args:
            lst_codeList (list): The list that holds all list of dicts with the code tables for each source system
            codeList_json (str): Location where to Json with the lst_codeList data is created
        """
...
if __name__ == "__main__":
    ...
    codeList_folder = Path(config["codeList_folder"])
    codeList_json = Path(config["codeList_json"])
    codelistmaker = CodeList(codeList_folder, codeList_json)
